...
(define-post 
  ...
  @div{
    ...
    @(side-note
       @h5{What did I do for the Kickstarter?}
       @(hr)
       @ul{
       @li{Prepped and sent out press releases to websites like @(a href: "https://www.gamasutra.com/blogs/LindseyHandley/20140918/225984/Kickstarting_a_Coding_Education_Video_Game_in_a_PostquotCode_Heroquot_World.php" "Gamasutra"), @(a href: "https://www.cnet.com/news/codespells-write-code-invent-magic-spells/" "CNET"), and @(a href: "https://www.rockpapershotgun.com/2014/09/02/codespells-proof-that-coding-is-arcane-wizardry/" "Rock, Paper, Shotgun").}
       @li{Tried (and often succeeded) to make GIFs go viral on 9Gag and @(a href: "https://imgur.com/gallery/Uvgt5" "Imgur").}
       @li{Answered backer questions and posted updates on Kickstarter.}
       @li{Managed the social media accounts.}
       @li{Generally shared the Kickstarter with anyone and everyone who might be interested in an awesome game that would let you code magic spells.}
       }
       )
    @p{The Kickstarter was a wild, exhilarating ride and ended up being a huge success! We ended up reaching 328% of our funding goal, which allowed us to build way more features than we had originally planned.}

    @(img:kickstarter-progress.png style: (properties margin: "auto" padding: 20 display: "block") width: "50%")
    ...
    @(image-grid
        ...
        (cons img:lindsey-and-fair-winner.jpg 
              @p{
              Posing with the winner of the 2014 Scholastic Coding Faire at UCSD.})
        (cons img:lindsey-stephen-stem-expo.jpg 
              @p{
    ...
    @p{Now, I'm excited to be back to serve the CodeSpells community!}

    @(side-note
       @h5{Over the next several months you'll find me:}
       @(hr)
       @ul{
